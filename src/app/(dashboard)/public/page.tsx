...
import { Store, Lock, LockOpen, User, Calendar, FolderOpen, DollarSign } from "lucide-react";
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please connect your wallet to browse public datasets.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="p-4 border-b bg-background">
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm text-gray-600">
                {publicFolders?.length || 0} dataset{(publicFolders?.length || 0) !== 1 ? 's' : ''} available
              </div>
            </div>
          </div>
            ...
            <>
              {(publicFolders?.length || 0) === 0 ? (
                <div className="flex flex-col items-center justify-center p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No datasets available yet</h3>
                  <p className="text-gray-600 mb-4">
                    Public datasets will appear here when they become available.
                  </p>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="p-4 space-y-3">
                            ...
                            {!isFree && (
                              <div className="flex items-center justify-between p-2 bg-gray-50 rounded-sm">
                                ...
                                <div className="flex items-center gap-1 text-gray-900 font-medium text-sm">
                                  ...
                                  <span>{formatPrice(folderData?.viewingPrice || BigInt(0))}</span>
                                </div>
                              </div>
                            )}
                            ...
                            >
                              {isFree ? "View Dataset" : "View Details"}
                            </Button>
                          </div>
                        </Card>
                      );
